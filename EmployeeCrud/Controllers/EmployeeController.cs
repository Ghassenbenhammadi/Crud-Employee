...
namespace EmployeeCrud.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public IActionResult Index(string SortField, string CurrenSortField, SortDirection SortDirection,string searchByName)
        {
            var employees =GetEmployees();
            if (string.IsNullOrEmpty(searchByName))
                employees = employees.Where(e => e.EmployeeName.ToLower().Contains(searchByName.ToLower())).ToList();
            //List<Employee> employees = DbContext.Employees.ToList();
            return View(this.SertEmployees(employees,SortField,CurrenSortField,SortDirection));
        }
